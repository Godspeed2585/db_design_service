...
public class DriverManagerController {
     ...
     * @return
     */
    @RequestMapping(value ="/changeDriverName",method = RequestMethod.POST)
    public RespBean changeDriverName(@Valid @RequestBody Map<String,Object> request, BindingResult bindingResult) {
        ...
        try
            {
                driverService.updateDriverName(dirverName, jobId);
                return new RespBean(1,"修改成功");
            }
        catch (Exception e)
        {
     ...
     * @return
     */
    @RequestMapping(value ="/changeDriverGender",method = RequestMethod.POST)
    public RespBean changeDriverGender(@Valid @RequestBody Map<String,Object> request, BindingResult bindingResult) {
        ...
        try
            {
                driverService.updateDriverName(gender, jobId);
                return new RespBean(1,"修改成功");
            }
        catch (Exception e)
        {
     ...
     * @return
     */
    @RequestMapping(value ="/changeDriverTime",method = RequestMethod.POST)
    public RespBean changeDriverTime(@Valid @RequestBody Map<String,Object> request, BindingResult bindingResult) {
        ...
        try
            {
                driverService.updateDriverTime(entryTime, jobId);
                return new RespBean(1,"修改成功");
            }
        catch (Exception e)
        {

...
public class PassengerManagerController {
    ...
    public GetAllPassengerReturnData searchPassengerByphoneNumber(@RequestParam String token) {
            ...
            return new GetAllPassengerReturnData(1,passengerInfoList);
    }
    ...
    public GetAllPassengerReturnData getPassengerByidCard(@RequestParam String token, String idCard) {
        ...
        {
            logger.info("查找失败");
            return new GetAllPassengerReturnData(404, null);
        }    
        }
            return new GetAllPassengerReturnData(404,null);
    }
